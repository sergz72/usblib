#ifndef USB_DEVICE_AT32F4_H
#define USB_DEVICE_AT32F4_H

#include <usb_device.h>

class USB_Device_AT32F4: public USB_Device {
  private:
    bool extended_buffers;

    void AssignEndpointsBuffers();
    void TCHandler();
    void EP_TCHandler(unsigned int ept_num);
  public:
    USB_Device_AT32F4(bool _extended_buffers);
